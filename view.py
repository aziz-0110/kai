...
class Ui_Form(QtWidgets.QWidget):
    ...
    def update_img(self, frame_ori, frame_pred):
        img_ori = self.convert_img(frame_ori)
        img_pred = self.convert_img(frame_pred)

        self.label_dp.setPixmap((img_ori.scaled(self.label_dp.size())))
        self.label_ori.setPixmap((img_pred.scaled(self.label_ori.size())))
