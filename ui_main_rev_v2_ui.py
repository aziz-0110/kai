...
# Form implementation generated from reading ui file '/home/main/Documents/riset/kai/kai/ui_main_rev_v2.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_ori_8 = QtWidgets.QLabel(self.frame_22)
        self.label_ori_8.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_8.setText("")
        self.label_ori_8.setObjectName("label_ori_8")
        self.verticalLayout_13.addWidget(self.label_ori_8)
        self.label_indi_dp = QtWidgets.QLabel(self.frame_22)
        ...
        self.verticalLayout_13.addWidget(self.label_indi_dp)
        self.label_ori_7 = QtWidgets.QLabel(self.frame_22)
        self.label_ori_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_7.setText("")
        self.label_ori_7.setObjectName("label_ori_7")
        self.verticalLayout_13.addWidget(self.label_ori_7)
        ...
        self.frame_20 = QtWidgets.QFrame(self.frame_23)
        ...
        self.label_ori_4 = QtWidgets.QLabel(self.frame_20)
        self.label_ori_4.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_4.setText("")
        self.label_ori_4.setObjectName("label_ori_4")
        self.verticalLayout_10.addWidget(self.label_ori_4)
        self.label_ori = QtWidgets.QLabel(self.frame_20)
        self.label_ori.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori.setText("")
        self.label_ori.setObjectName("label_ori")
        self.verticalLayout_10.addWidget(self.label_ori)
        self.label_grap = QtWidgets.QLabel(self.frame_20)
        self.label_grap.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_grap.setText("")
        self.label_grap.setObjectName("label_grap")
        self.verticalLayout_10.addWidget(self.label_grap)
        ...
        self.label_ori_6 = QtWidgets.QLabel(self.frame_21)
        self.label_ori_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_6.setText("")
        self.label_ori_6.setObjectName("label_ori_6")
        self.verticalLayout_3.addWidget(self.label_ori_6)
        self.label_ori_5 = QtWidgets.QLabel(self.frame_21)
        self.label_ori_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_5.setText("")
        self.label_ori_5.setObjectName("label_ori_5")
        self.verticalLayout_3.addWidget(self.label_ori_5)
        self.label_ori_2 = QtWidgets.QLabel(self.frame_21)
        self.label_ori_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.label_ori_2.setText("")
        self.label_ori_2.setObjectName("label_ori_2")
        self.verticalLayout_3.addWidget(self.label_ori_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_9.setText(_translate("Form", "Grafik"))
